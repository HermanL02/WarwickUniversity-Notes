...
The application should allow users to exchange public keys by direct user inputs and also to bind their WeChat uid and store the public key to the cloud for quick exchange. 
