...
## Ideas
Therefore, we need to make a E2EE tool to achieve E2EE function that is a open source code itself, only uses open source code to ensure safety, fits the legal requirement and can be used easily.
