...
## Comments Reducing
Regarding comments, it is really controversy. Many code examples encourage writing clear comments and docs. However, during the development process and the advice of my collegues, I realized that the code readability is not really achived by massive comments. It is based on clear and simple naming. When a function of the variable 
