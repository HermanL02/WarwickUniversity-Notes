...
To use the app, the users need to install the app through the executables in the build folder. In the case if the Windows version is not working as expected, the user can also use 'yarn start' on a Win
