...
The core thing to support multi language is to use language files, such as JSON or YAML. These contains all the strings that are translatable in the application and will be put in the seperate folder to use them. 
