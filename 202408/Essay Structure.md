...
##### GitHub Contents
The first method involves hosting the assets on GitHub Contents or a similar global content delivery network (CDN), from which the installer fetches the required files during the installation process. This is widely used by multiple start up companies, like Solana. 
