...
Similar to MERN stack, we choose NeDB as our local database. Compare to MongoDB, it is more light weighted and more common for a DB that only serves a single process. It also keeps the NoSQL DB feature and similar command as MongoDB. 
