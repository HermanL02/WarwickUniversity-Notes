...
In our testing period, I tested several cases, and I observed that if the spray value is between 60-10 and 60+10, the vulnerability will inject the shellcode into the server. 