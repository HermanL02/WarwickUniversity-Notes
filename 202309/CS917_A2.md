...
We keep finding the minimal edge. We observe if it connects the two nodes in the same forest. If it does not connect two nodes in the same forest, then we can combine the two node in their original forest as a new forest. 
# Question 8
```
