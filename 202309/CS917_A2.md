...
# Question 5 
## Explanation
The question given is a undirected graph. We assign the start vertex as A as the question required. Therefore, we can calculate the the distance from start point A, the distances of B and C are 17 and 47 separately. Other distances here would be considered as infinity. 
## Result
