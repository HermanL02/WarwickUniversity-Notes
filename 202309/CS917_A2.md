...
## Part 2 
First, I create a dictionary that associate the morse code without the first character to the all possible characters. Ex. ".-"->"A", "--" to "-" -> "A". It costs O(1) time because the time to run it does not related to the input. 
