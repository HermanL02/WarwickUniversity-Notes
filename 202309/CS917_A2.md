...
d. FALSE, [For sufficiently large values of n, the growth rate of f(n) is the same as the growth rate of g(n), or f(n) is tightly bound by Θ(g(n)):
](https://docs.google.com/presentation/d/1QqE7X-4YgEPJ2tEFAPW5cKEGJGbwp_EcW6AkKso3Nx0/edit#slide=id.p16 
