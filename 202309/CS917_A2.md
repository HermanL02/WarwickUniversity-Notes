...
### Explanation
Prim algorithm is used to construct a minimal spanning tree by repetitively selecting the minimal edge the current nodes could reach. 
...
Basically, we see the nodes we visited as a whole, and then we observe all the lines, which connect this whole to any other unvisited nodes. Then we choose the lowest 
## Question b. 
### Table
