...
1. We define some variables. 
   ...
   Stack: to pop the location and the path of each visited spot. The path specifies all the history from its starting point to the current point. 
