...
Basically, we see the nodes we visited as a whole, and then we observe all the lines, which connect this whole to any other unvisited nodes. Then we choose the lowest value among these lines, and let the node connected to this line join the whole. Then compare it again. 
