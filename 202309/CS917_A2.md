...
d. TRUE, because the Big $\Omega$ notation means [For sufficiently large values of n, the growth rate of f(n) is never less than g(n)](https://docs.google.com/presentation/d/1QqE7X-4YgEPJ2tEFAPW5cKEGJGbwp_EcW6AkKso3Nx0/edit#slide=id.p11) . 
