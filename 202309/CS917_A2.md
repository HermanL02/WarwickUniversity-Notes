...
We assign the start vertex as A as the question required. Therefore, we can see the distances of B and C are 17 and 47 separately, and other distances here would be considered as infinity. The smallest value would be B. 
