...
# Motivation
## WeChat Market Place
According to the latest report of Chinese , WeChat already have 1 billion daily active users. It means almost everyone in China use WeChat as their. The second one is QQ, which is also a Tencent app, that has over 300 thousand daily active users. 
## WeChat vs. Privacy
