...
# Motivation
## WeChat Market Place
According to the latest data of Chinese instant message apps, WeChat has over 1 billion daily active users. The second one is QQ, which has over 300 thousand daily active users. It has more 
## WeChat vs. Privacy
