...
### Using VPN
When I was in mainland, I was trying to use VPN to chat with my friends. I was concerned about lots of things. First, the connection is not stable. I believe not only I, but also the other users are concerning about the quality of the connection. It prevents us from using it as the instant chat. After that, if I decide to talk about something legal but sensitive, I have to use WeChat to tl
### Any products before? 
