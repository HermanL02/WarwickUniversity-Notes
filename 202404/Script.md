...
## WeChat Update
We have noticed that WeChat could implement a force login restriction when the version is too low. There are two ways for us to solve this. First, the open source GitHub and probably I will continue to update WeChat In
