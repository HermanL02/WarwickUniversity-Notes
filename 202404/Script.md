...
It sounds not reality to create a keyboard on our own. However, which keyboard should we use to begin? There are some recent research from the University of Toronto reveals that most 
