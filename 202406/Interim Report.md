...
In this article here, it also investigates the picture live detection is based on automatical detection and audit. The audit is based on the OCR of the target https://citizenlab.ca/2019/07/cant-picture-this-2-an-analysis-of-wechats-realtime-image-filtering-in-chats/
## Current Solutions
### Substitution Words
