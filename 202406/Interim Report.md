...
## Timeline
The rest time would be focused on stablize the software. I plan to create a 10 people testing team, and do the A/B testing for them, see which software they gonna choose as the secure communication tool during the daily life, whether they choose to use a VPN or a product like
