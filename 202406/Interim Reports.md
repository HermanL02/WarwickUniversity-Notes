...
During the Master's degree period, it is almost impossible for a student to design a easy to use input method to be competitive as the main Chinese competitors like Sogou and Baidu. But recently, the Chinese competitors are influenced by 
### Code Structure
