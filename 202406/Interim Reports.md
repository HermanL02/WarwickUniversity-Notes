...
### General Structure
The main code structure would be the same, as we want to keep its keyboard functionality as much as possible. The only change would be regarding the welcome screen and the top bar. We added 
### Details
