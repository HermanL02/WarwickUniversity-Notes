...
The thirds issue would be the interaction. Java/Kotlin and JavaScript generally should be considered as similar ones, but there is a werid issue when we set same RSA protocol and its configurations.  This is generally resolved and we might use a more universal package for both Android and Windows applications. 
# Evaluation
