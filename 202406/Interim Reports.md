...
Therefore, in this report, we want to introduce an End-to-End Encryption solution for WeChat, which may potentially provide people who can only access to mainland chat apps and 
